...
void TIM2_PWM_Init(u32 psc, u32 arr, u32 pulse);     /* PA2 — 电机, 32位定时器 */
void TIM3_PWM_Init(u32 psc, u32 arr, u32 pulse);     /* PA6 — 舵机, 16位定时器 */
